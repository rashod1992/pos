...
if(!empty($_POST)){
	...
	if(isset($_GET['cx_id']) && is_numeric($_GET['cx_id'])){
		$product_info = $cms->loadCustomerById($_GET['cx_id']);
		$values_array['cx_name'] = $product_info['cx_name'];
		$values_array['cx_email'] = $product_info['cx_email'];
		$values_array['cx_address'] = $product_info['cx_address'];
		$values_array['cx_telephone'] = $product_info['cx_telephone'];
	}
}
?>
<!DOCTYPE html>
...
<?PHP include('inc-leftmenu.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?PHP  echo CUSTOMERS;?>
        <small><?PHP echo ADD_CUSTOMERS;?></small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
       ...
       <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?PHP echo ADD_CUSTOMERS;?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
